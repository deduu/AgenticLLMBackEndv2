...
class QwenModel(BaseModel):
    ...
    async def generate_function_call(self, messages: List[Dict[str, str]], tools: List[Any]) -> str:
        # Implement Qwen-specific function call generation
        ...
        logger.info(f"Qwen generated function call: {response}")
        return response
    ...
    async def generate_text(self, messages: List[Dict[str, str]], max_new_tokens: int) -> str:
        ...
        try:
            ...
            logger.info(f"Qwen generated text: {generated_response}")
